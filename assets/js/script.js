...
function mensProduct() {
    ...
    for (var i = 0; i < mens.length; i++) {
        mensProductDiv.innerHTML += `
                                    ...
                                    <img src="${mens[i].image}" class="card-img-top prod-image mt-3" alt="...">
                                    <div class="card-body">
    ...
    // mensBtn.removeEventListener('click', mensProduct);
}
...
function womenProduct() {
    ...
    for (var i = 0; i < women.length; i++) {
        womenProductDiv.innerHTML += `
                                    <div class="card mb-4 prod-display" style="width: 20rem;">
                                    <img src="${women[i].image}" class="card-img-top prod-image mt-3" alt="...">
                                    <div class="card-body">
                                        <h5 class="card-title">${women[i].desc}</h5>
                                        <p class="card-text">Available Sizes: ${women[i].size}</p>
                                        <p class="card-text">Price: $ ${women[i].price}</p>
                                        <a href="#" class="btn btn-primary">Add to cart</a>
                                    </div>
                                    </div>`;
    }
    // womenBtn.removeEventListener('click', womenProduct);
}